...
class HelperView(discord.ui.View):
    ...
    async def second_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Вот все доступные команды:\n>question - создать канал для вопроса учителю.\n>docs - команда по выдачи "
            "документаций и полезных материалов для учеников!",
            view=HelperView())
...
class DocsView3(discord.ui.View):
    ...
    async def firstProject_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Официальная документация - https://doc.qt.io/qtforpython-5/contents.html \nУдобное краткое руководство - "
            "https://translated.turbopages.org/proxy_u/en-ru.ru.2ace4ec1-660bcb43-5c3e9812-74722d776562/https/www"
            ".tutorialspoint.com/pyqt5/pyqt5_quick_guide.htm \nВидео про кнопки на англ. - "
            "https://www.youtube.com/watch?time_continue=423&v=-2uyzAqefyE&embeds_referring_euri=https%3A%2F"
            "%2Fyastatic.net%2Fvideo-player%2F0xe7891f6f377%2Fpages-common%2Fyoutube%2Fyoutube.html&source_ve_path"
            "=Mjg2NjY&feature=emb_logo \nВидео про простейший калькултор на PyQt5 - "
            "https://www.youtube.com/watch?time_continue=292&v=7aAF0s7-5io&embeds_referring_euri=https%3A%2F"
            "%2Fyastatic.net%2Fvideo-player%2F0xe7891f6f377%2Fpages-common%2Fyoutube%2Fyoutube.html&source_ve_path"
            "=Mjg2NjY&feature=emb_logo \n Туториал по работе с PyQt5 и QtDesigner (Создание гениратора паролей) -  "
            "https://www.youtube.com/watch?time_continue=454&v=pMNrxE1xAfw&embeds_referring_euri=https%3A%2F"
            "%2Fyastatic.net%2Fvideo-player%2F0xe7891f6f377%2Fpages-common%2Fyoutube%2Fyoutube.html&source_ve_path"
    ...
    async def secondProject_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Скачать SQLiteStudio - https://sqlitestudio.pl/ \nSQLiteStudio как пользоваться - "
            "https://www.youtube.com/watch?v=QH_wPA0ojRc \nБольшая практическая шпаргалка SQL (SQLite) с готовыми "
            "запросами - https://habr.com/ru/articles/792630/ \nКомнада для добавления иной удобной бибилеотки: "
            "```pip install pymysql```",
            view=DocsView3())
    ...
    async def thirdProject_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Официальная документация - https://pygame-docs.website.yandexcloud.net/ref/pygame.html \nВидео как "
            "сделать игру на весь экран - https://www.youtube.com/watch?v=wP7PJohQOMc \nВидео как сделать меню - "
            "https://www.youtube.com/watch?v=kqrlD8X8pdw \nШпаргалка - "
            "https://waksoft.susu.ru/2019/04/24/pygame-shpargalka-dlja-ispolzovanija/ \nКоманда для import - ```pip "
            "install pygame```",
            view=DocsView3())
    ...
    async def fourthProject_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Официальная документация - https://flask.palletsprojects.com/en/3.0.x/ \nFlask шпаргалка(англ) - "
            "https://codeinsightacademy.com/blog/python/flask-cheat-sheet/ \nFlask работа с базой данных - "
            "https://www.youtube.com/watch?v=_CwCk5g8YJg&t=2s \nКоманда для import -```pip install Flask```",
            view=DocsView3())
    ...
    async def fiveProject_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Официальная документация по телеграм боту - https://docs.python-telegram-bot.org/en/stable/index.html "
...
class DocsView2(discord.ui.View):
    ...
    async def firstModule_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Видео как скачать python - https://yandex.ru/video/preview/11147201474752498360 \nВидео итструкция (не "
            "официальная) - https://yandex.ru/video/preview/12460819480399738578 \nСсылка на скачивание с сайта "
            "разработчиков - https://www.jetbrains.com/pycharm-edu/ \n",
            view=DocsView2())
    ...
    async def secondModule_button_callback(self, interaction, button):
        await interaction.response.send_message(
            "Вспомогательный курс по Python - https://itproger.com/course/python \n Удобная документация - "
